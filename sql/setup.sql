...
(5, 'Witches purportedly have familiars, supernatural entities who attend to them.'),
...
(3, 'Some scientists claim that a zombie apocalypse is not necessarily an impossibility...'),
(3, 'In some cultures, including much of the African and Caribbean traditions from which the word ''zombie'' originated, zombies are more mindless servants...'),
(3, 'Prolific zombie filmmaker George A. Romero''s first paid directing job was filming Mr. Rogers'' tonsillectomy for Mr. Rogers'' Neighborhood...'),
...
(2, 'Female demons called the Lilu were said to hunt women and children at night and drink their blood.'),
...
(2, 'In the Twilight films, the reason the Cullens have golden brown eyes is because they don''t drink human blood. When a vampire hasn''t had any blood for a few weeks, their eyes go black...'),
...
(1, 'There are different types of ghosts. Orbs for example, appear as floating balls of light. Other ghosts can appear as mist or fog. Another, called the funnel ghost, shows up as a blurry spot in photographs.'),
(2, 'Anne Rice''s novel Interview With the Vampire was published in 1976 with a film adaptation in 1994. The vampire Lestat is based on Anne Rice''s husband Stan Rice.'),
(1, 'In Nepalese folklore or mythology, kichkanya is a spirit of a woman that is latched to an uncremated part of her dead body, usually a bone...'),
(4, 'Mary Wollstonecraft Shelley came up with the idea for “Frankenstein” during a competition with Lord Byron and her husband. The competition was to see who could write the best scary story.'),
